...
2. Run monitoring commands to collect baseline data (when server is idle)
3. Start an application or workload on the server
4. Run the same monitoring commands during the workload to collect performance data
5. Compare baseline vs. workload data to identify performance characteristics
6. Record data in tables for analysis
